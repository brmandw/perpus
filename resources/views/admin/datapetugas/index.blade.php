                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; height: 100px;">
                                <a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editPetugas{{ $users->id }}">
                                    <i class="bi bi-pen"></i>
                                </a>
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deletePetugas{{ $users->id }}">
